...
**Örnek:**
\`\`\`${client.ayarlar.prefix}erkek @codex 
${client.ayarlar.prefix}erkek @codex codex 21

${client.ayarlar.prefix}erkek 318998310989987840
${client.ayarlar.prefix}erkek 318998310989987840 codex 21\`\`\``)).then(a => a.delete({timeout: 10000}));
