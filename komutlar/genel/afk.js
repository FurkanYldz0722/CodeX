...
exports.run = async (client, message, args) => {
  ...
  var display = message.guild.members.cache.get(message.author.id).displayName;
  ...
  message.channel.send(
    new Discord.MessageEmbed()
      .setTitle(`${message.author.username}, tebrikler!`)
      .setColor("GREEN")
      .setDescription(`${sebep} sebebiyle afk moduna giriş yaptın.`)
  );
