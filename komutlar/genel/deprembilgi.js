...
var efe = ""
 ...
 .setDescription(`[Bilgiler Kandilli Rasathanesinden Alınmıştır](http://www.koeri.boun.edu.tr/sismo/2/son-depremler/liste-halinde/)`)
    .setColor("RED")
...
for (const ayn of cikti) {
  embed.addField(`__${ayn.lokasyon}__`,` **Zaman:** ${ayn.date} **Büyüklük:** ${ayn.mag} - **Derinlik:** ${ayn.depth}km \n`)
}
