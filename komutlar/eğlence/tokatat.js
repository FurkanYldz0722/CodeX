...
if(message.author.id === message.mentions.members.first().id) return message.channel.send(new Discord.MessageEmbed().setColor('#00567e').setTitle('Ulen Yavaşş!').setDescription('Kendine tokat atıcaksın olum sakin.')).then(a => a.delete({timeout: 10000}))
